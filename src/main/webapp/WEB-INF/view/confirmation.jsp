...
<head>
 ...
 <br/><br/>
      ...
      <label>
                    ...
                    <input type="text" name="Confirm"  readonly="readonly"><br/><br/>
               
                    
                    <span>Email</span>
                    <input type="email" name="email"  readonly="readonly"><br/><br/>
                    
                    <span>(Area)- Number</span>
                    <input type="tel" name="contactNumber"  readonly="readonly"><br/><br/>
                   
 					<span>Street Address</span>
                    <input type="Addr" name="Street Address"  readonly="readonly"><br/><br/>
                    
                    <span>Street Address Line 2</span>
                    <input type="Addr" name="Street Address1"  readonly="readonly"><br/><br/>
                    
                    <span>City</span>
                    <input type="City" name="City"  readonly="readonly"><br/><br/>
                    
                    <span>State OR Province</span>
                    <input type="State" name="State"  readonly="readonly"><br/><br/>
                    
                    <span>Postal/ZipCode</span>
                    <input type="Zip" name="Zip"  readonly="readonly"><br/><br/>
                    
                    <span>Country</span>
                    
 					<select class="form-dropdown form-address-country" defaultcountry="" name="q4_billingAddress[country]" id="input_4_country"  readonly="readonly">
                    ...
                    <input type="Amt" name="Payment"  readonly="readonly"><br/><br/>
                   
          			<span>CARD#</span>
                    <input type="Card" name="Card"  readonly="readonly"><br/><br/>
                   
                    <span>CVV</span>
                    <input type="cvv" style="width:100px" name="cvv" readonly="readonly"><br/><br/>
                   </label><br/><br/>
