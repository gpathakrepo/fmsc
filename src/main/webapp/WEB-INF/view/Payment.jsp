...
<head>
 ...
 <br/><br/>
      ...
      <label>
                    ...
                    <input type="tel" name="contactNumber"><br/><br/>
                   
 					<span>Street Address</span>
                    <input type="Addr" name="Street Address"><br/><br/>
                    
                    <span>Street Address Line 2</span>
                    <input type="Addr" name="Street Address1"><br/><br/>
                    ...
                    <input type="Zip" name="Zip"><br/><br/>
                    
                    <span>Country</span>
                    
 					<select class="form-dropdown form-address-country" defaultcountry="" name="q4_billingAddress[country]" id="input_4_country">
                    ...
                    <input type="Amt" name="Payment"><br/><br/>
                    <span>Payment using</span>
                    <select class="form-dropdown validate[required]" style="width:150px" id="input_10" name="q10_iWill">
            <option value="">  </option>
            ...
            <option value="AMEX"> AMEX </option>
          			...
          			<span>CARD#</span>
                    <input type="Card" name="Card"><br/><br/>
                    <span>Expiration Month</span>
                    <select class="form-dropdown validate[required]" name="q27_sessionDate27[month]" id="input_27_month">
             ...
             <select class="form-dropdown validate[required]" name="q27_sessionDate27[year]" id="input_27_year">
              ...
              <option value="2014"> 2016 </option>
                    ...
                    <span>CVV</span>
                    <input type="cvv" style="width:100px" name="cvv"><br/><br/>
                   </label><br/><br/>
